...
public class Neo4jRestClient {
	...
	public ObjectNode createParameters(Object ... args) {
		...
		Preconditions.checkArgument(args.length %2 ==0, "must be an even number of arguments (key/value pairs)");
		...
		for (int i=0; i<args.length; i+=2) {
			...
			if (val==null) {
				...
				throw new IllegalArgumentException("type for param "+key+" not supported: "+val.getClass().getName());
			}
